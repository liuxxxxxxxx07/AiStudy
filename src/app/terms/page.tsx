...
export default function TermsPage() {
  return (
    <LegalPage title="Terms of Service">
      ...
      <h2 className="text-lg font-semibold mt-8 mb-2">3. User Accounts</h2>
      <p>
      ...
      <h2 className="text-lg font-semibold mt-8 mb-2">4. Subscriptions & Billing</h2>
      <p>
        Paid plans are billed monthly or annually as selected. Subscriptions auto-renew unless cancelled before the renewal date. You may cancel at any time through your account settings. Upon cancellation, access to paid features continues until the end of the current billing period.
      </p>
      <p>
      ...
      <h2 className="text-lg font-semibold mt-8 mb-2">5. Credits</h2>
      <p>
      ...
      <h2 className="text-lg font-semibold mt-8 mb-2">6. Acceptable Use</h2>
      <p>
        You agree not to:
      </p>
      ...
      <h2 className="text-lg font-semibold mt-8 mb-2">7. Limitation of Liability</h2>
      <p>
      ...
      <h2 className="text-lg font-semibold mt-8 mb-2">8. Changes to Terms</h2>
      <p>
      ...
      <p>
        For questions about these terms, contact support through the app or email the address listed on our pricing page.
      </p>
    </LegalPage>
  );
}