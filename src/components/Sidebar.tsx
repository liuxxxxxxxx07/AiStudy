...
import { Moon, Sun, Trash2, PanelLeftClose, Bookmark, BookOpen, GraduationCap, Search, Sparkles, LogOut, Coins, GitBranch, Plus } from "lucide-react";
  ...
  return (
    <aside className="w-60 flex-shrink-0 h-full bg-sidebar-bg border-r border-sidebar-border flex flex-col">
      ...
      <div className="flex-1 overflow-y-auto px-2 pb-2">
        <button
          onClick={onNewChat}
          className="flex items-center gap-2 w-full px-2.5 py-2 rounded-lg text-[12px] font-medium text-muted hover:text-foreground hover:bg-hover-bg transition-colors mb-1"
        >
