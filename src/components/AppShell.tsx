...
: c
  ...
  return (
    <div className="flex h-full">
      ...
      <div className="fixed bottom-0 left-0 right-0 z-10 flex items-center justify-center gap-3 py-1.5 text-[10px] text-muted/40 bg-background/80 backdrop-blur-sm border-t border-divider/50 pointer-events-auto">
        <span>AI Study</span>
        <span>·</span>
